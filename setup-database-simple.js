...
async function setupDatabase() {
  ...
  try {
    ...
    try {
      ...
      console.log('Foreign key users_schoolId_fkey already exists or failed');
    }
    ...
    try {
      ...
      console.log(
        'Foreign key school_admins_userId_fkey already exists or failed'
      );
    }
    ...
    try {
      ...
      console.log(
        'Foreign key school_admins_schoolId_fkey already exists or failed'
      );
    }
    ...
    try {
      ...
      console.log('Foreign key students_userId_fkey already exists or failed');
    }
    ...
    try {
      ...
      console.log(
        'Foreign key students_schoolId_fkey already exists or failed'
      );
    }
    ...
    try {
      ...
      console.log('Foreign key exams_schoolId_fkey already exists or failed');
    }
    ...
    try {
      ...
      console.log('Foreign key questions_examId_fkey already exists or failed');
    }
    ...
    try {
      ...
      console.log(
        'Foreign key answers_studentId_fkey already exists or failed'
      );
    }
    ...
    try {
      ...
      console.log(
        'Foreign key answers_questionId_fkey already exists or failed'
      );
    }
    ...
    try {
      ...
      console.log('Foreign key answers_examId_fkey already exists or failed');
    }
    ...
    try {
      ...
      console.log(
        'Foreign key results_studentId_fkey already exists or failed'
      );
    }
    ...
    try {
      ...
      console.log('Foreign key results_examId_fkey already exists or failed');
    }
    ...
    try {
      ...
      console.log(
        'Foreign key payments_schoolId_fkey already exists or failed'
      );
    }
    ...
    const teachers = [
      ...
      {
        id: 'teacher-003',
        email: 'peter.teacher@school.com',
        name: 'Peter Williams',
        employeeId: 'EMP003',
    ...
    const teacherAssignments = [
      {
        teacherId: 'teacher-profile-teacher-001',
      ...
      {
        teacherId: 'teacher-profile-teacher-002',
      ...
      {
        teacherId: 'teacher-profile-teacher-003',
