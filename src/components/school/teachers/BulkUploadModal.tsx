...
const uploadSteps: UploadStep[] = [
  ...
  },
  {
    id: 2,
    title: 'Map Columns',
    description: 'Map file columns to teacher fields',
    completed: false,
  },
  {
    id: 3,
    title: 'Validate Data',
    description: 'Review and validate teacher data',
    completed: false,
  },
  {
    id: 4,
    title: 'Import Teachers',
    description: 'Import validated teachers to system',
    completed: false,
  },
];
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      toast({
        title: 'Import Failed',
        description:
          error instanceof Error ? error.message : 'Failed to import teachers',
        variant: 'destructive',
      });
    } finally {
      setIsUploading(false);
                ...
                <CardContent className="p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <p className="text-2xl font-bold">
                        {
                          parsedTeachers.filter(t => t.status === 'invalid')
                            .length
                        }
                      </p>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <p className="text-2xl font-bold">
                        {
                          parsedTeachers.filter(t => t.status === 'duplicate')
                            .length
                        }
                      </p>
                ...
                {isUploading && (
                  <div className="space-y-2 mb-6">
                    ...
                    <p className="text-sm text-gray-500">
                      Importing teachers... {uploadProgress.toFixed(0)}%
                    </p>
                  </div>
                )}
