        ...
        <CardContent className="p-0">
                      ...
                      <TableCell onClick={(e) => e.stopPropagation()}>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => onClassClick(classItem)}>
          ...
          <div className="md:hidden space-y-4 p-4">
            {classes.length === 0 ? (
              ...
              classes.map((classItem) => (
                <Card key={classItem.id} className="p-4 cursor-pointer hover:shadow-md transition-shadow" onClick={() => onClassClick(classItem)}>
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => setDeleteClass(classItem)}>
                            <Trash2 className="h-4 w-4 mr-2" />
                            Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              This action cannot be undone if the class has no students or exams.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
