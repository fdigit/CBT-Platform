...
export function EditClassModal({ isOpen, onClose, onClassUpdated, classItem, teachers }: EditClassModalProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-3">Select teachers to assign to this class</p>
