  ...
  const fetchTeacherStats = async () => {
    try {
      ...
      if (classesResponse.ok && subjectsResponse.ok) {
        ...
        const pendingTasks = subjectsData.subjects?.reduce((sum: number, subject: any) => 
          sum + (subject.pendingAssignments || 0), 0) || 0
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-2xl font-bold text-green-600">{stats.classAverageScore}%</span>
                </div>
              ...
              {recentActivity.map((activity) => (
                <div key={activity.id} className="flex items-center space-x-3">
                  <Avatar className="h-8 w-8">
                    <AvatarImage src={activity.avatar} alt={activity.studentName} />
                    <AvatarFallback>
            ...
            <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-1">
                  The new automated grading system will be rolled out next week. Please review the guidelines.
                </p>
            ...
            <div className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">
                  The examination timetable for this term has been published. Check your assigned slots.
                </p>
