    ...
    try {
      ...
      const response = await fetch('/api/teacher/assignments', {
        ...
        body: JSON.stringify({
          ...
          subjectId:
            newAssignment.subject === 'general' ? null : newAssignment.subject,
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Create, assign, and manage assignments, notes, and resources for
              your students
            </p>
          </div>
            ...
            >
              ...
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Create a new assignment, note, resource, or test for your
                    students.
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={value =>
                          setNewAssignment(prev => ({ ...prev, class: value }))
                        }
                      >
                        <SelectTrigger>
                    ...
                    <Textarea
                      ...
                      placeholder={
                        newAssignment.type === 'note'
                          ...
                          : newAssignment.type === 'resource'
                            ? 'Provide details about this resource...'
              ...
              {filteredAssignments.map(assignment => (
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {assignment.averageScore && (
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-medium">
                            {assignment.averageScore.toFixed(1)} pts
                          </span>
                        </div>
                      )}
                    ...
                    {assignment.status === 'published' &&
                      ['note', 'resource'].includes(assignment.type) && (
            ...
            {filteredAssignments.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">
                  No assignments or notes found
                </h3>
                <p className="mt-1 text-sm text-gray-500">
                  {searchQuery
                    ? 'Try adjusting your search criteria.'
                    : 'Get started by creating your first assignment or note.'}
                </p>
                {!searchQuery && (
                  <Button
                    className="mt-4"
