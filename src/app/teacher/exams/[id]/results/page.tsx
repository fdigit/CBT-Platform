...
export default function ExamResultsPage({
  ...
  const [selectedStudent, setSelectedStudent] = useState<ExamResult | null>(
    null
  );
  ...
  const handleResetAttempts = async () => {
    ...
    if (
      !confirm(
        'Are you sure you want to reset ALL student attempts for this exam? This will delete all attempts, answers, and results. This action cannot be undone.'
      )
    ) {
      return;
    }
    ...
    try {
      const response = await fetch(
        `/api/teacher/exams/${examId}/reset-attempts`,
        {
          method: 'POST',
          headers: {
                    ...
                    <TableCell>
                      <div>
                        <p className="font-medium">
                          {result.score}/{examData.totalMarks}
                        </p>
                        <p className="text-sm text-gray-500">
                    ...
                    <TableCell>
                      <Dialog>
                        ...
                        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                          <DialogHeader>
                            <DialogTitle>
                              Exam Details - {result.studentName}
                            </DialogTitle>
                            <DialogDescription>
