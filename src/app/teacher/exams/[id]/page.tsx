...
export default function TeacherExamDetailPage() {
  ...
  const handleSubmitForApproval = async () => {
    if (
      !exam ||
      !confirm(
        `Submit "${exam.title}" for admin approval? You won't be able to edit it after submission.`
      )
    ) {
      return;
    }
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-md">
                ...
                <Badge
                  variant={exam.negativeMarking ? 'destructive' : 'outline'}
                >
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-md">
                ...
                <Badge
                  variant={exam.showResultsImmediately ? 'default' : 'outline'}
                >
          ...
          <Card className="border-red-200 bg-red-50">
            ...
            <CardContent>
              <p className="text-red-700">
                This exam was rejected by the school admin. Please review the
