...
export async function PUT(
  ...
  try {
    ...
    if ((reviewStatus === 'REJECTED' || reviewStatus === 'NEEDS_REVISION') && !reviewNotes?.trim()) {
      return NextResponse.json(
    ...
    const reviewMessages: Record<string, string> = {
      ...
      'REJECTED': 'Your lesson plan has been rejected. Please review the feedback and create a new version.',
      'NEEDS_REVISION': 'Your lesson plan needs revision. Please review the feedback and resubmit.'
    }
