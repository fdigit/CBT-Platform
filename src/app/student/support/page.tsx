...
const FAQ_ITEMS = [
  {
    ...
    answer: "Navigate to 'My Exams' and click 'Start Exam' on any active exam. Make sure you have a stable internet connection and your browser is up to date.",
    category: "exams"
  },
  {
    question: "What happens if I lose internet connection during an exam?",
    answer: "Your answers are automatically saved every 30 seconds. If you lose connection, reconnect and continue where you left off. Contact support if you need additional time.",
    category: "technical"
  },
  {
    question: "How can I view my exam results?",
    answer: "Go to the 'Results' section in your dashboard. You can view detailed scorecards, download PDF reports, and track your performance over time.",
    category: "results"
  },
  {
    question: "Can I change my profile information?",
    answer: "Yes, go to 'Profile' to update your personal information. Note that your email and student ID cannot be changed - contact support if needed.",
    category: "account"
  },
  {
    question: "What browsers are supported?",
    answer: "We support the latest versions of Chrome, Firefox, Safari, and Edge. For the best experience, ensure JavaScript is enabled and pop-ups are allowed.",
    category: "technical"
  },
  {
    question: "How do I reset my password?",
    answer: "Go to 'Profile' → 'Security Settings' to change your password. If you forgot your password, use the 'Forgot Password' link on the login page.",
    category: "account"
  }
]
...
export default function SupportPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'open':
        return <Badge variant="secondary" className="bg-blue-50 text-blue-700">Open</Badge>
      case 'in_progress':
              ...
              <CardContent>
                {tickets.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">Submit your first support ticket to get help</p>
                  </div>
                ) : (
