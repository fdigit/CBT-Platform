        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                <div
                  className={`text-4xl font-bold ${getGradeColor(result.result.percentage)}`}
                >
                  {result.result.score}/{result.totalMarks}
                </div>
                <div
                  className={`text-2xl font-semibold ${getGradeColor(result.result.percentage)}`}
                >
                  {result.result.percentage.toFixed(1)}%
                </div>
                <div
                  className={`text-3xl font-bold ${getGradeColor(result.result.percentage)} mt-2`}
                >
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {result.statistics.answeredQuestions}/
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {result.teacher?.user?.name || 'Unknown'}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-600">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-900">
                    {new Date(result.attempt.startedAt).toLocaleString()}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-600">
